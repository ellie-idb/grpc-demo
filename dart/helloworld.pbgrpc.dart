...
class GreeterClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.HelloReply> sayGoodBye($0.HelloRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$sayGoodBye, request, options: options);
  }
}
...
abstract class GreeterServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.HelloReply> sayGoodBye_Pre(
      $grpc.ServiceCall call, $async.Future<$0.HelloRequest> request) async {
    return sayGoodBye(call, await request);
  }

  $async.Future<$0.HelloReply> sayHello(
      $grpc.ServiceCall call, $0.HelloRequest request);
  $async.Future<$0.HelloReply> sayGoodBye(
      $grpc.ServiceCall call, $0.HelloRequest request);
}
